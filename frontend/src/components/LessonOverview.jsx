...
const accents = [
  { border: "rgba(139,60,247,0.35)", bg: "rgba(139,60,247,0.12)", text: "#c4a0ff", iconBorder: "rgba(139,60,247,0.4)" },
...
export default function LessonOverview({ onNavigate }) {
  return (
    <section style={{ padding: "88px 0", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 28px" }}>
        ...
        <div style={{ marginBottom: "48px", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "clamp(1.8rem, 3.5vw, 2.6rem)", color: "#FAFAFA" }}>
              What You'll{" "}
              ...
              >
                <div style={{ display: "flex", alignItems: "flex-start", gap: "10px" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <h3 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "13px", color: "#FAFAFA", marginTop: "1px", lineHeight: 1.25 }}>
                      {lesson.shortTitle}
                    </h3>
                  </div>
                </div>
                <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "11px", color: "rgba(250,250,250,0.4)", lineHeight: 1.65, flex: 1 }}>
